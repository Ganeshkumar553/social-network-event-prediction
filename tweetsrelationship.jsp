...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>  Tweets and Hashtag Sense Clustering </span></h2>
          <div class="img"></div>
          <div class="article">
            <p align="justify"> 
	...
	String s1,s2,s3,s4,str1="#",result="";
	int i=0,j=0,m=0;
	...
	while ( rs.next() )
	{
		...
		%>
		 ...
		 <td  width="109" height="50" align="center" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style5">Tweet image </div></td>
				  ...
				  <td   width="206" height="50" align="center" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style5">Tweet Description</div></td>
				  <td  width="126" height="50" align="center" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style5">Date</div></td>
					...
					<%}%>
			<tr>
			  <td  width="97" height="50" align="center" valign="middle" style="color:#000000;"><div align="center" class="style6"><%out.println(s1);%></div></td>
		<td width="109"><input  name="image" type="image" style="width:100px; height:100px;" src="profile_pic.jsp?id=<%=i%>&type=<%="tweet"%>"/></td>

			  <td  width="97" height="50" align="center" valign="middle" style="color:#000000;"><div align="center" class="style6"><%out.println(s2);%></div></td>	
			  <td  width="206" height="50" align="center" valign="middle">
			  ...
			  res=res.startsWith("#")?res.substring(1):res;
	  			al.add(res);
			  s3=s3.replace(matcher.group(j),"<b><i><u><a href=related_links.jsp?key="+res+"&amp;tname="+s2+">"+matcher.group(j)+"</a></big></u></i></b>");			
			  }
			  }
			  out.println(s3);%>
		        </div></td>
			  <td  width="126" align="center" valign="middle"><div align="center" class="style6"><%out.println(s4);%></div></td>
				...
				if(!(al.isEmpty()))
				{
				 String sql1="select * from hashwords where tname='"+s2+"'";
				 Statement st1=connection.createStatement();
				 ResultSet rs1=st1.executeQuery(sql1);
				 if(rs1.next())
			 {
				  String sql2="update hashwords set des_hash='"+al+"' where tname='"+s2+"'";
				 Statement st2=connection.createStatement();
				 st2.executeUpdate(sql2);
			 }
			 else
			 {
				  String sql3="insert into hashwords(tname,des_hash)values('"+s2+"','"+al+"')";
