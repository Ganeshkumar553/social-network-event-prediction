	...
	while ( rs.next() )
	{
		...
		%>
				...
				<tr>
			      ...
			      <td  width="102" valign="baseline" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style6">Comments</div></td>
				</tr>
					<%}%>
				<tr>
						
	   	<td width="109"><input  name="image" type="image" style="width:100px; height:100px;" src="profile_pic.jsp?id=<%=i%>&type=<%="tweet"%>"/></td>
			  <td  width="97" height="110" align="center" valign="middle" style="color:#000000;"><div align="center" class="style7"><%out.println(s1);%></div></td>	
			  <td  width="206" height="110" align="center" valign="middle"><div align="center" class="style7"><%out.println(s2);%></div></td>
			  <td  width="126" align="center" valign="middle"><div align="center" class="style7"><%out.println(s3);%></div></td>
			  <td  width="102" height="110" align="center" valign="middle"><div align="center" class="style7"><a href="comments.jsp?name=<%=s1%>&id=<%=i%>">View Comments</a></div></td>
		</tr>
