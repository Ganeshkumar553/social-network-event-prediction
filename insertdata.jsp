...
<%
					...
					if ( rs1.next() )
					   {
					   		out.print("User Name Already Exist <br/>");
							
							%>
							<p><a href="userlogin.jsp">Click here to Login<br/></a><br/>         <a href="index.html">Home</a> </p>
					   ...
					   {
						PreparedStatement ps=connection.prepareStatement("insert into user(username,password,email,mobile,dob,gender,address,pincode,status,image) values(?,?,?,?,?,?,?,?,?,?)");
			...
			%>
			<p><a href="userlogin.jsp">Click here to Login<br/> <br/></a>        <a href="index.html">Home</a> </p>
