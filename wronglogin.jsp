...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style4">Login Failed..!!! </h2>
          <p class="infopost">&nbsp;</p>
          <div class="img"></div>
          <div class="article">
            <p align="justify" class="article">
...
%>
  <a href="userlogin.jsp">Click here to go back</a>		<a href="index.html"><span class="">Home Page</span></a>
  </BR>
  <%}
else{
%>
